...
from app.api.v1 import assets, audit, governance, glossary, ingestion_jobs, mcp_internal, operations, policy, proposals, search_index, sources
...
app.include_router(proposals.router, prefix=settings.api_v1_prefix)
